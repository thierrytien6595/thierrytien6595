...
// DOANH THU ƯỚC TÍNH
$now = date('Y-m-d');
$query = "SELECT SUM(DATHANHTOAN) AS DATHANHTOAN FROM hoadon WHERE TIMEOUT>'$now'"; 
$result = mysqli_query($conn, $query);
$row = $result->fetch_assoc();
$DThomnay = $row['DATHANHTOAN'];
if ($DThomnay==null) {
	$DThomnay="0";
  } 
...
array_push($QLArray, new QUANLY($DTUOCTINH,$TONGTIEN,$SOBAN_PV,$SOMON_PV,$SOMON_CPV,$SOBAN_CPV,$DOANHTHUArray));
